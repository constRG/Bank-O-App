...
public class successfully_cashed_out extends AppCompatActivity {
    ...
    private String date_and_time, cash_out_id;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_successfully_cashed_out);

        _init_();

        amount = getIntent().getDoubleExtra("CASH_OUT_AMOUNT",0);
        date_and_time = getIntent().getStringExtra("DATE_AND_TIME");
        cash_out_id = getIntent().getStringExtra("CASH_OUT_ID");

        date_and_time_holder.setText(date_and_time);
        amount_holder.setText("₱"+ String.valueOf(df.format(amount)));
        cash_out_id_holder.setText("Ref id." + cash_out_id);

        continue_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(successfully_cashed_out.this, MainActivity.class);
    ...
    public void _init_() {
        ...
        cash_out_id_holder = findViewById(R.id.cash_out_id_holder);
        continue_btn = findViewById(R.id.continue_btn);
        download_btn = findViewById(R.id.download_btn);

        ActivityCompat.requestPermissions(successfully_cashed_out.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,
                Manifest.permission.WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
    }

    public void print_cashed_out_pdf() {
        ...
        paint.setTextSize(7);
        canvas.drawText("Ref id." + cash_out_id, canvas.getWidth()/2, 90, paint);
        ...
        paint.setTextSize(8);
        canvas.drawText("Transaction method: cashed out", 20, 130, paint);
        ...
        String filePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/bank-o-cashed-out-receipt.pdf";
